        ...
        <form action="Signup.inc.php" method="post">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="usersUid" placeholder="Nickname" required="required">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="email" class="form-control" name="usersEmail" placeholder="Email Address" required="required">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" name="usersPwd" placeholder="Password" required="required">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" name="confirm_usersPwd" placeholder="Confirm Password" required="required">
                </div>
            </div>
        ...
        <?php
            if(isset($_GET["error"])) {
                if($_GET["error"] == "emptyinput"){
                    ...
                    echo "<script>alert('무언가가 잘못 되었습니다 관리자에게 연락주세요.');</script>";
                }
